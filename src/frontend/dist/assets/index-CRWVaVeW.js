  ...
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const p of particles) {
        ...
        ctx.fillStyle = p.hue === 285 ? `rgba(168,85,247,${alpha})` : `rgba(0,212,255,${alpha})`;
        ctx.beginPath();
...
function GameCard({
  ...
  const ocid = index2 <= 20 ? `games.item.${index2}` : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      onClick: () => onPlay(game),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square overflow-hidden bg-muted w-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 flex-1 flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body font-semibold leading-tight line-clamp-2 text-foreground/90", children: game.name }) })
      ]
    }
  );
}
function RecentCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      type: "button",
      "data-ocid": `recently_played.item.${index2}`,
      className: "game-card flex-shrink-0 w-28 cursor-pointer group text-left",
      onClick: () => onPlay(game.id),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-28 h-28 rounded-md overflow-hidden border border-border", children: [
          !imgError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: coverUrl,
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Gamepad2,
            {
              className: "w-8 h-8",
              style: { color: "#a855f7", opacity: 0.6 }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { style: { color: "#00d4ff", width: 24, height: 24 } }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-center mt-1 line-clamp-2 text-muted-foreground group-hover:text-foreground transition-colors", children: game.name })
      ]
    }
  );
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-5 space-y-6 overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xs tracking-widest text-muted-foreground", children: "DISPLAY" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xs tracking-widest text-muted-foreground", children: "PANIC KEY" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Press this key anywhere to instantly redirect to Google." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 font-body", children: "Single character (e.g. F, P, Escape)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg border border-border bg-muted/20 space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-xs font-display tracking-widest",
                  style: { color: "#00d4ff" },
                  children: "TAB CLOAKING"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: 'Tab appears as "Google" with Google favicon to stay discreet.' })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3 h-3 mr-2" }),
                "SAVE SETTINGS"
              ]
            }
          ) })
...
function App() {
  const [darkMode, setDarkMode] = reactExports.useState(() => {
    try {
      ...
      if (s) return JSON.parse(s).darkMode ?? true;
    } catch {
    }
    return true;
  });
  const [panicKey, setPanicKey] = reactExports.useState(() => {
    try {
      const s = localStorage.getItem(SETTINGS_KEY);
      if (s) return JSON.parse(s).panicKey ?? "";
    } catch {
    }
    return "";
  });
  ...
  const [recentlyPlayed, setRecentlyPlayed] = reactExports.useState(() => {
    try {
      const r2 = localStorage.getItem(RECENT_KEY);
  ...
  const gamesRef = reactExports.useRef(null);
  const recentRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (!panicKey) return;
    const handler = (e) => {
      if (e.key === panicKey || e.key.toLowerCase() === panicKey.toLowerCase()) {
  ...
  const addToRecentlyPlayed = reactExports.useCallback((game) => {
    setRecentlyPlayed((prev) => {
      const filtered = prev.filter((r2) => r2.id !== game.id);
      const updated = [
  ...
  const playGame = reactExports.useCallback(
    async (game) => {
      addToRecentlyPlayed(game);
      const resolvedUrl = game.url.startsWith("http") ? game.url : game.url.replace("{HTML_URL}", HTML_BASE);
      if (game.url.startsWith("http")) {
        ...
        if (!popup) return;
        try {
          const html = await fetch(resolvedUrl).then((r2) => r2.text());
          popup.document.open();
  ...
  const playById = reactExports.useCallback(
    (id) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen relative", "data-ocid": "home.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleCanvas, { darkMode }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 h-16 flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-black tracking-wider gradient-text", children: "∞ INFINITE GAMES" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-1 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                onClick: () => scrollTo(homeRef, "home"),
                className: `px-3 py-1.5 rounded font-display text-xs tracking-widest transition-all ${activeSection === "home" ? "text-neon-blue" : "text-muted-foreground hover:text-foreground"}`,
                style: activeSection === "home" ? { textShadow: "0 0 10px #00d4ff" } : {},
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "inline w-3 h-3 mr-1" }),
                  "HOME"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `px-3 py-1.5 rounded font-display text-xs tracking-widest transition-all ${activeSection === "games" ? "text-neon-blue" : "text-muted-foreground hover:text-foreground"}`,
                style: activeSection === "games" ? { textShadow: "0 0 10px #00d4ff" } : {},
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "inline w-3 h-3 mr-1" }),
                  "GAMES"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `px-3 py-1.5 rounded font-display text-xs tracking-widest transition-all ${activeSection === "recent" ? "text-neon-blue" : "text-muted-foreground hover:text-foreground"}`,
                style: activeSection === "recent" ? { textShadow: "0 0 10px #00d4ff" } : {},
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "inline w-3 h-3 mr-1" }),
                  "RECENT"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "inline w-3 h-3 mr-1" }),
                  "SETTINGS"
                ]
              }
            )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                style: {
                  ...
                  borderColor: search ? "#00d4ff" : void 0,
                  boxShadow: search ? "0 0 10px rgba(0,212,255,0.3)" : void 0
                }
              }
            ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative z-10 max-w-7xl mx-auto px-4 py-8 space-y-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ref: homeRef,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                ...
                children: "∞ INFINITE GAMES"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground max-w-lg mx-auto", children: "Your gateway to endless gaming. Hundreds of games, one click away." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: { color: "#a855f7" },
                  children: loading ? "LOADING..." : `${games.length} GAMES`
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
      ...
      recentlyPlayed.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: recentRef, "data-ocid": "recently_played.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4", style: { color: "#00d4ff" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              className: "font-display text-sm tracking-widest",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 overflow-x-auto pb-3 scrollbar-neon", children: recentlyPlayed.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          RecentCard,
          {
            game: g,
            onPlay: playById,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: gamesRef, "data-ocid": "games.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-4 h-4", style: { color: "#a855f7" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              className: "font-display text-sm tracking-widest",
              ...
              children: search ? `RESULTS: "${search}"` : "ALL GAMES"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-game text-xs text-muted-foreground", children: filteredGames.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "h-px flex-1",
        ...
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: SKELETON_KEYS.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg overflow-hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "aspect-square w-full skeleton-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-3/4 mt-2 mx-2 skeleton-pulse" })
            ] }, key))
          }
        ),
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm tracking-widest text-destructive", children: "FAILED TO LOAD GAMES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: error }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  type: "button",
        ...
        !loading && !error && filteredGames.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm tracking-widest text-muted-foreground", children: "NO GAMES FOUND" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground/60", children: "Try a different search term" })
            ]
          }
        ),
        !loading && !error && filteredGames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "grid gap-3",
            style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative z-10 border-t border-border py-6 mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xs tracking-widest gradient-text", children: "∞ INFINITE GAMES" }),
